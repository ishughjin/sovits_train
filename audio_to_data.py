...
def process_audio_data(
    ...
    exp_root = "path/to/experiment/root"  # Define this appropriately
    opt_dir = f"{exp_root}/{experiment_name}"

    try:
        # Step 1: Process text
        text_output_path = f"{opt_dir}/2-name2text.txt"
        ...
        semantic_output_path = f"{opt_dir}/6-name2semantic.tsv"
