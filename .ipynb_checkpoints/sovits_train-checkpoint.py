...
def train_sovits(
    ...
    # Check if "../autodl-tmp/" + exp_name exists, create if it doesn't
    save_weight_dir = os.path.join("../autodl-tmp", exp_name)
    ...
    config["save_weight_dir"] = save_weight_dir
...
# The rest of your FastAPI application code remains the same
